#!/bin/bash
#SBATCH --job-name=traj_8B_8f
#SBATCH --partition=mcml-dgx-a100-40x8
#SBATCH --qos=mcml
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=/dss/dsshome1/06/di38riq/rl_multi_turn/logs/trajectory_test_8B_8frames_%j.log
#SBATCH --error=/dss/dsshome1/06/di38riq/rl_multi_turn/logs/trajectory_test_8B_8frames_%j.log

# Trajectory test: 8B model, 8 frames, 20 random questions
# Output: trajectory_test_run/8B/8_frames/
