#!/bin/bash
#SBATCH --job-name=traj_4B_16f
#SBATCH --partition=mcml-dgx-a100-40x8
#SBATCH --qos=mcml
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=/dss/dsshome1/06/di38riq/rl_multi_turn/logs/trajectory_test_4B_16frames_%j.log
#SBATCH --error=/dss/dsshome1/06/di38riq/rl_multi_turn/logs/trajectory_test_4B_16frames_%j.log

# Trajectory test: 4B model, 16 frames, 20 random questions
# Output: trajectory_test_run/4B/16_frames/
