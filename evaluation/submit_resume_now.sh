...
# Resume VSI-Bench Sequential Evaluation — writing to SCRATCH, NO DELAY
# Submits immediately without --begin delay.
#
...
#
# Usage: ./submit_resume_now.sh <MODEL> <FRAMES> <NUM_SPLITS>
# Example: ./submit_resume_now.sh 4B 32 2
#          ./submit_resume_now.sh 8B 32 12
...
echo "======================================================================"
echo "RESUME VSI-BENCH SEQUENTIAL EVALUATION (SCRATCH OUTPUT, IMMEDIATE)"
echo "======================================================================"
...
echo "All jobs start immediately (no delay)"
echo ""
...
JOB_LIST_FILE="${LOG_DIR}/resume_now_jobs_${MODEL}_${FRAMES}f.txt"
