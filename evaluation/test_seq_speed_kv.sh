...
#SBATCH --qos=mcml
#SBATCH --output=/dss/dsshome1/06/di38riq/rl_multi_turn/logs/seq_kv_speed_test_%j.log

# Sequential KV-Cache Speed Test
# Tests 10 random questions with 16 frames (15 steps), 8B model, vLLM with KV-cache

echo "======================================================================"
echo "SEQUENTIAL KV-CACHE SPEED TEST"
echo "======================================================================"
echo "Questions: 10 random from combined dataset"
echo "Frames: 16 (15 steps)"
echo "Model: Qwen3-VL-8B-Instruct"
echo "Backend: vLLM with KV-Cache optimization"
echo "======================================================================"
...
# Sample the SAME 10 random questions (same seed=42)
echo ""
echo "Sampling 10 random questions (seed=42 for reproducibility)..."
python3 -c "
import random
import json
import sys
...
# Sample 10 random - SAME seed as test_seq_speed.sh
...
echo ""
echo "Starting sequential KV-cache evaluation..."
echo "Start time: $(date)"
START_TIME=$(date +%s)

python3 evaluation/sequential_kv_cache.py --dataset combined --steps 15 --question-types all
...
echo ""
echo "======================================================================"
echo "KV-CACHE SPEED TEST COMPLETE"
echo "======================================================================"
echo "End time: $(date)"
